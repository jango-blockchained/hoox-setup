...
Read the file `src/components/dashboard/nav-main.tsx` to understand current structure.

- [ ] **Step 2: Add Agent section to navItems array**

Add the Agent section with collapsible children after the Settings item:
...
Also import `Brain` from `lucide-react` at the top of the file.

- [ ] **Step 3: Update NavMain component to support children**
...
git add pages/dashboard/src/components/dashboard/nav-main.tsx
git commit -m "feat(dashboard): add Agent section to sidebar navigation"
```
