...
<ol>
  <li><strong>Always write reversible migrations</strong> — include both <code>UP</code> and <code>DOWN</code> scripts.</li>
  <li><strong>Never modify existing migrations</strong> — create new ones for schema changes.</li>
  <li><strong>Test locally first</strong> — run <code>hoox db apply</code> without <code>--remote</code> to verify.</li>
  <li><strong>Backup before migrating</strong> — export your production database first.</li>
</ol>
