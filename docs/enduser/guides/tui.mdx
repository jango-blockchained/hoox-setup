...
- **[Local Development Guides](local-development)** — Spin up the API dev server that feeds the TUI.
- **[CLI Reference Manual](../reference/cli-commands)** — Read the commands running under the TUI hood.
