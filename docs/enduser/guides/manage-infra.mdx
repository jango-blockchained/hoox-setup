...
<ol>
  <li><strong>D1 SQLite Database</strong> (<code>hoox-db</code>).</li>
  <li><strong>CONFIG\_KV</strong> Namespace bucket.</li>
  <li><strong><code>trade-execution</code></strong> messaging Queue.</li>
  <li><strong><code>trade-reports</code></strong> and <strong><code>system-logs</code></strong> R2 object storage buckets.</li>
  <li><strong><code>rag-index</code></strong> Vectorize vector search database.</li>
</ol>
