...
<ol>
  <li><strong>D1 Edge Database</strong> (<code>hoox-db</code>)</li>
  <li><strong>CONFIG\_KV</strong> configuration namespace</li>
  <li><strong>Internal Workers</strong> (<code>trade-worker</code>, <code>d1-worker</code>, <code>telegram-worker</code>)</li>
  <li><strong>Public Gateway</strong> (<code>hoox</code> gateway router)</li>
  <li><strong>Next.js Dashboard Command Center</strong> (<code>workers/dashboard</code>)</li>
</ol>
