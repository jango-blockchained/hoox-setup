...
<Tip>Testing analytics locally? Local Wrangler dev automatically intercepts `writeDataPoint` calls and logs the parsed Blobs and Doubles straight to your terminal standard output, ensuring easy debugging!</Tip>
