...
<Note>
  [`docs/devops/api/endpoints.md`](../api/endpoints) for complete endpoint
...
<Note>
  See
  [`docs/devops/api/endpoints.md#ingress-webhook-endpoints`](../api/endpoints#-ingress-webhook-endpoints-workershoox)
</Note>
...
<Note>
  See
  [`docs/devops/api/endpoints.md#database-service-endpoints`](../api/endpoints#-database-service-endpoints-workersd1-worker)
</Note>
...
<Note>
  See
  [`docs/devops/api/endpoints.md#ai-risk--chat-endpoints`](../api/endpoints#-ai-risk--chat-endpoints-workersagent-worker)
</Note>
...
For a quick reference table of all endpoints without detailed descriptions, see the internal agent context file at `.opencode/context/project-intelligence/lookup/endpoints.md`.
...
- **[End User Configuration Guide](../../enduser/getting-started/configuration)** — Map out your build-time environment configurations.
