...
<Note>For the complete, up-to-date bindings reference, see **[`docs/devops/bindings.md`](../bindings)**.</Note>
>
...
<Note>[`docs/devops/bindings.md#secrets--environment-variables`](../bindings#secrets--environment-variables) for the complete list.</Note>
...
<Note>[`docs/devops/bindings.md#service-bindings`](../bindings#service-bindings) for the complete list.</Note>
...
<Note>[`docs/devops/bindings.md#kv-namespace-bindings`](../bindings#kv-namespace-bindings) for the complete list.</Note>
...
<Note>[`docs/devops/bindings.md#r2-bucket-bindings`](../bindings#r2-bucket-bindings) for the complete list.</Note>
...
<Note>[`docs/devops/bindings.md#d1-database-bindings`](../bindings#d1-database-bindings) for the complete list.</Note>
...
<Note>[`docs/devops/bindings.md#ai-bindings`](../bindings#ai-bindings) and [`docs/devops/bindings.md#vectorize-bindings`](../bindings#vectorize-bindings) for the complete list.</Note>
...
<Note>[`docs/devops/bindings.md#browser-rendering`](../bindings#browser-rendering) for the complete details.</Note>
...
<Tip>Adding new bindings to your workers? Always update your `wrangler.jsonc` manifest at the workspace root, and then execute `hoox deploy update-internal-urls` to sync bindings and URLs globally!</Tip>

### 🔗 Next Steps

- **[Canonical Bindings Reference](../bindings)** — Complete, up-to-date bindings table.
- **[Storage & SQLite DDL](storage)** — Dive into Drizzle schemas, R2 bucket configurations, and database rules.
- **[Production Deployments](../deployment/production)** — Learn how Wrangler compiles and maps these bindings to the live edge.
