...
<Note>Health check endpoints (`GET /health`) are intentionally left unauthenticated for monitoring systems.</Note>
...
See [Load Testing README](../../tests/load/README) for full documentation.
