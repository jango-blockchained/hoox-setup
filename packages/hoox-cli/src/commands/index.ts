...
export { WorkersMonitorCommand as workersMonitor } from "./workers/monitor.js";
...
export { DashboardUpdateUrlsCommand as dashboardUpdateUrls } from "./dashboard/update-urls.js";
