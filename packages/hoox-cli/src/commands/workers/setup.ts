...
export class WorkersSetupCommand implements Command {
  ...
  options = [
    { flag: "worker", short: "w", type: "string" as const, description: "Specific worker to setup" },
    { flag: "all", short: "a", type: "boolean" as const, description: "Setup all enabled workers" },
  ];
