...
describe("DashboardView", () => {
  ...
  it("color-codes alerts by severity with labels", () => {
    mockState.alerts = [
      makeAlert({ id: "a1", severity: "info", message: "Info msg", timestamp: 4000 }),
      makeAlert({ id: "a2", severity: "warning", message: "Warn msg", timestamp: 3000 }),
      makeAlert({ id: "a3", severity: "error", message: "Err msg", timestamp: 2000 }),
      makeAlert({ id: "a4", severity: "critical", message: "Crit msg", timestamp: 1000 }),
    ]
  ...
  it("shows scroll hint with position counter", () => {
    mockState.alerts = Array.from({ length: 5 }, (_, i) =>
      makeAlert({ id: `a${i}`, message: `Alert ${i}`, timestamp: 5000 - i * 1000 }),
    )
    const output = renderDashboard()
