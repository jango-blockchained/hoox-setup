...
describe("Colors Design System", () => {
  ...
  describe("token completeness", () => {
    ...
    it("all required semantic tokens exist", () => {
      const required = [
        "background", "foreground", "card", "accent", "border",
        "muted", "dim", "success", "error", "warning", "info",
      ]
  ...
  describe("edge cases", () => {
    ...
    it("contrast ratio of same color is 1.0", () => {
      expect(contrastRatio(Colors.background, Colors.background)).toBeCloseTo(1.0, 1)
    })
