...
function filterCommands(commands: CommandEntry[], query: string): CommandEntry[] {
...
const SAMPLE_COMMANDS: CommandEntry[] = [
  ...
  { id: "workers", name: "Workers Overview", category: "view", shortcut: "Ctrl+2" },
  { id: "trade-monitor", name: "Trade Monitor", category: "view", shortcut: "Ctrl+4" },
  { id: "refresh", name: "Refresh Data", category: "action", shortcut: "Ctrl+R" },
  { id: "dark-theme", name: "Dark Theme", category: "setting" },
  { id: "light-theme", name: "Light Theme", category: "setting" },
  { id: "save-config", name: "Save Configuration", category: "action", description: "Persist current settings to disk" },
  { id: "reset-defaults", name: "Reset to Factory Defaults", category: "setting", aliases: ["reset", "factory"] },
  { id: "quit-app", name: "Quit Application", category: "action", shortcut: "Ctrl+Q" },
  { id: "toggle-sidebar", name: "Toggle Sidebar", category: "action", shortcut: "Ctrl+B" },
]
...
describe("Shared Components", () => {
  ...
  describe("StatusDot", () => {
    ...
    it("all three status values have distinct colors", () => {
      const colors = [DOT_COLOR.operational, DOT_COLOR.degraded, DOT_COLOR.down]
    ...
    it("pulse only applies to operational status", () => {
      ...
      const degradedPulse = pulse && ("degraded" as StatusDotStatus) === "operational"
  ...
  describe("CommandPalette", () => {
    ...
    describe("scoreCommand", () => {
      it("scores prefix match highest (100)", () => {
        const cmd = { id: "dash", name: "Dashboard", category: "view" as CommandCategory }
      ...
      it("returns 1 for empty query", () => {
        const cmd = { id: "any", name: "Anything", category: "view" as CommandCategory }
        expect(scoreCommand("", cmd)).toBe(1)
      })

      it("returns -1 for no match", () => {
        const cmd = { id: "any", name: "Dashboard", category: "view" as CommandCategory }
    ...
    describe("keyboard navigation", () => {
      it("wrap-around up from first goes to last", () => {
        ...
        let selectedIndex = 0
        selectedIndex = selectedIndex > 0 ? selectedIndex - 1 : Math.max(0, lastIndex)
      ...
      it("down moves selection down", () => {
        let selectedIndex = 1
        const lastIndex = 5
        selectedIndex = selectedIndex < lastIndex ? selectedIndex + 1 : selectedIndex
