            ...
            <div className="flex flex-col gap-4 p-4">
              ...
              <div className="flex flex-col gap-2">
                {DEPLOYED_WORKERS.map((worker) => (
                  <div
                    key={worker.name}
                    className={`flex items-center justify-between p-2.5 rounded-md border ${worker.status === "active" ? "border-border/50 bg-secondary/20 hover:bg-secondary/40" : "border-border/20 bg-muted/10 opacity-70"} transition-colors group`}
                  >
            ...
            <div className="flex flex-col gap-4 p-4">
              ...
              <div className="flex flex-col gap-2">
                {DEPLOYED_PAGES.map((page) => (
                  <div
                    key={page.name}
                    className={`flex items-center justify-between p-2.5 rounded-md border ${page.status === "active" ? "border-border/50 bg-secondary/20 hover:bg-secondary/40" : "border-border/20 bg-muted/10 opacity-70"} transition-colors group`}
                  >
                    <div className="flex flex-col gap-0.5 overflow-hidden">
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-sm truncate">
            ...
            <div className="flex flex-col gap-4 p-4">
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <div
                    key={resource.name}
                    className={`flex items-center justify-between p-2.5 rounded-md border ${resource.status === "active" ? "border-border/50 bg-secondary/20 hover:bg-secondary/40" : "border-border/20 bg-muted/10 opacity-70"} transition-colors group`}
                  >
                    <div className="flex flex-col gap-0.5 overflow-hidden">
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-sm truncate">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {Object.values(CF_SERVICES).map((service) => {
                ...
                return (
                  <div
                    key={service.name}
                    className={`flex items-start gap-3 p-3 rounded-xl border ${service.bgColorClass} bg-opacity-50 transition-all hover:scale-[1.02]`}
                  >
                    <div
                      className={`p-2 rounded-lg bg-background/50 backdrop-blur-sm ${service.colorClass}`}
                    >
